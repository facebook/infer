...
class GuardedByTests {
  @GuardedBy("this")
  private var unguardedBadField = 0
  ...
  @GuardedBy("this")
  private var synchronizedField = 0

  @Synchronized fun synchronizedMethodOk() {
    synchronizedField = 0
  }
  ...
  @GuardedBy("this")
  private var unguardedReadField = 0
  ...
  @GuardedBy("this")
  private var privateUnguardedField = 0
  ...
  @GuardedBy("this")
  private var privateInterprocSynchronizedField = 0
 ...
 @Synchronized
  ...
  @GuardedBy("this")
  private var visibleForTestingField = 0
