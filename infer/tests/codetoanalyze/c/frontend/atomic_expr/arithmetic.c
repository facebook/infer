...
void opencl_builtins() {
    ...
    _o = __opencl_atomic_fetch_add(&o, 1, __ATOMIC_SEQ_CST, __OPENCL_MEMORY_SCOPE_WORK_GROUP);
    _o = __opencl_atomic_fetch_sub(&o, 1, __ATOMIC_SEQ_CST, __OPENCL_MEMORY_SCOPE_WORK_GROUP);
    _o = __opencl_atomic_fetch_and(&o, 1, __ATOMIC_SEQ_CST, __OPENCL_MEMORY_SCOPE_WORK_GROUP);
    _o = __opencl_atomic_fetch_or(&o, 1, __ATOMIC_SEQ_CST, __OPENCL_MEMORY_SCOPE_WORK_GROUP);
    _o = __opencl_atomic_fetch_xor(&o, 1, __ATOMIC_SEQ_CST, __OPENCL_MEMORY_SCOPE_WORK_GROUP);
}
...
void unimplemented() {
    ...
    __opencl_atomic_fetch_max(&a, 0, __ATOMIC_SEQ_CST, __OPENCL_MEMORY_SCOPE_WORK_GROUP);
    __opencl_atomic_fetch_min(&a, 0, __ATOMIC_SEQ_CST, __OPENCL_MEMORY_SCOPE_WORK_GROUP);
}
