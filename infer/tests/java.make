...
CLASSPATH=$(ANDROID):$(ANDROIDX_COLLECTION):$(ANDROIDSUPPORT):$(ANNOTATIONS):$(GUAVA):$(JACKSON):$(JSR305):$(INJECT):$(KOTLIN_ANNOTATIONS):$(SUNTOOLS):$(COMMONS_JAR):$(COMMONS3_JAR):$(LOMBOK_JAR):$(JAVA_BUILTINS_DIR):$(TEST_CLASSPATH):.
