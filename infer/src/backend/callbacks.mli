...
val iterate_procedure_callbacks :
  AnalysisRequest.t -> ?specialization:Specialization.t -> Summary.t -> Procdesc.t -> Summary.t
...
val iterate_file_callbacks_and_store_issues : Procname.t list -> SourceFile.t -> unit
