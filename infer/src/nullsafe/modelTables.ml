...
let field_nullability =
  ...
  ; ("java.nio.channels.FileChannel$MapMode.READ_ONLY", o)
  ; ("java.nio.channels.FileChannel$MapMode.READ_WRITE", o)
  ; ("java.nio.channels.FileChannel$MapMode.PRIVATE", o)
  ...
  ; ("java.util.Locale.CANADA", o)
  ; ("java.util.Locale.CANADA_FRENCH", o)
  ; ("java.util.Locale.CHINA", o)
  ; ("java.util.Locale.CHINESE", o)
  ; ("java.util.Locale.ENGLISH", o)
  ; ("java.util.Locale.FRANCE", o)
  ; ("java.util.Locale.FRENCH", o)
  ; ("java.util.Locale.GERMAN", o)
  ; ("java.util.Locale.GERMANY", o)
  ; ("java.util.Locale.ITALIAN", o)
  ; ("java.util.Locale.ITALY", o)
  ; ("java.util.Locale.JAPAN", o)
  ; ("java.util.Locale.JAPANESE", o)
  ; ("java.util.Locale.KOREA", o)
  ; ("java.util.Locale.KOREAN", o)
  ; ("java.util.Locale.PRC", o)
  ; ("java.util.Locale.PRIVATE_USE_EXTENSION", o)
  ; ("java.util.Locale.ROOT", o)
  ; ("java.util.Locale.SIMPLIFIED_CHINESE", o)
  ; ("java.util.Locale.TAIWAN", o)
  ; ("java.util.Locale.TRADITIONAL_CHINESE", o)
  ; ("java.util.Locale.UK", o)
  ; ("java.util.Locale.UNICODE_LOCALE_EXTENSION", o)
  ; ("java.util.Locale.US", o)
