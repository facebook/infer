...
and capture_ullbc =
  CLOpt.mk_path_list ~long:"capture-ullbc" ~meta:"path"
    "Generate a SIL program from a ullbc file generated by charon."
...
and capture_ullbc = RevList.to_list !capture_ullbc
