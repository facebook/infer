...
val has_return_annot : Exe_env.t -> (Annot.Item.t -> bool) -> Procname.t -> bool

val is_functional : Exe_env.t -> Procname.t -> bool
...
val is_thread_confined_method : Exe_env.t -> Tenv.t -> Procname.t -> bool
...
val should_analyze_proc : Exe_env.t -> Tenv.t -> Procname.t -> bool
...
val is_thread_safe_method : Exe_env.t -> Procname.t -> Tenv.t -> bool
...
val is_marked_thread_safe : Exe_env.t -> Procname.t -> Tenv.t -> bool
...
val should_flag_interface_call :
  Exe_env.t -> Tenv.t -> HilExp.t list -> CallFlags.t -> Procname.t -> bool
...
val is_initializer : Exe_env.t -> Tenv.t -> Procname.t -> bool
...
val is_kotlin_coroutine_generated : Typ.Name.t -> bool
