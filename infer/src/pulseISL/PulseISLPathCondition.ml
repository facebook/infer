  ...
  let subst, citvs_callee_renamed =
    CItvs.fold
      (fun v_callee citv (subst, citvs) ->
        ...
        L.d_printfln "*******and_citvs_callee.v_callee: %a@\n" AbstractValue.pp v_callee;
        L.d_printfln "*******and_citvs_callee.v_caller: %a@\n" AbstractValue.pp v_caller;
