...
(** Check that the [address] is valid or invalid. otherwise, abduce *)
...
val check_memory_leak: Location.t -> AbstractValue.Set.t -> t -> t access_result
...
val remove_vars : (* Procdesc.t -> *) Var.t list -> Location.t -> t -> (t list) access_result
...
val call :
     callee_data:(Procdesc.t * PulseISLSummary.t) option
  -> Location.t
  -> Procname.t
  -> ret:Ident.t * Typ.t
