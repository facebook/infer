...
(** [is_equal_to astate t i] returns [true] if [astate |- t = i], [false] if we don't know for sure *)
  
val is_known_neq_zero : AbductiveDomain.t -> AbstractValue.t -> bool
(** [is_known_neq_zero astate t] returns [true] if [astate |- t != 0], [false] if we don't know for sure *)
