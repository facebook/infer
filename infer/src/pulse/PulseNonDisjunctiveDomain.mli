...
module Summary : sig
  ...
  val get_transitive_callees_if_not_top : t -> TransitiveInfo.Callees.t option
...
val remember_dropped_elements : Trace.Set.t -> TransitiveInfo.Callees.t -> Typ.Name.Set.t -> t -> t
