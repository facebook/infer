...
module Attributes : sig
  ...
  val get_tainted : t -> (Taint.source * ValueHistory.t) option

  val get_taint_sanitized : t -> Taint.sanitizer option
  ...
  val get_must_not_be_tainted : t -> (Timestamp.t * Taint.sink * Trace.t) option
