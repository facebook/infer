...
type t =
  ...
  | DeepDeallocate
      (** generated by calls to unknown functions to remember that a pointer and everything
          reachable from it has been passed to an unknown function and so has potentially been
          deallocated *)
...
module Attributes : sig
  ...
  val is_deep_deallocated : t -> bool
