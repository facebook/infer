...
let%expect_test "numbers lexing" =
  ...
  [%expect
    {|
    Textual: Type Error: ident n2 is assigned (with type float), but it has already been assigned at line 7 (with type float) in dummy.sil at line 11, column 11
    Textual: Type Error: ident n3 is assigned (with type float), but it has already been assigned at line 8 (with type float) in dummy.sil at line 12, column 11
    Textual: Type Error: ident n4 is assigned (with type float), but it has already been assigned at line 9 (with type float) in dummy.sil at line 13, column 11
    Textual: Type Error: ident n5 is assigned (with type float), but it has already been assigned at line 10 (with type float) in dummy.sil at line 14, column 11
    |}]
