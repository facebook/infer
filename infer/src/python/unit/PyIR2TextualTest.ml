  ...
  [%expect
    ...
    define dummy::__module_body__() : *PyObject {
      #b0:
          ...
          n0 = () -> dummy::f($builtins.py_make_none(), $builtins.py_make_none(), $builtins.py_make_none(), $builtins.py_make_none())
          _ = $builtins.py_store_name("f", locals, globals, n0)
          n1 = () -> dummy::g($builtins.py_make_none(), $builtins.py_make_none(), $builtins.py_make_none(), $builtins.py_make_none())
