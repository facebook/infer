  ...
  [%expect
    ...
    define dummy::f(globals: *PyGlobals, locals: *PyLocals) : *PyObject {
      ...
      #b2:
          ...
          n1 = $builtins.py_load_local("l", n18)
          n19 = $builtins.py_make_none()
          n2 = $builtins.py_get_iter(n19, n1)
          jmp b3

      #b3:
          n20 = $builtins.py_make_none()
          n3 = $builtins.py_next_iter(n20, n2)
          n21 = $builtins.py_make_none()
          n4 = $builtins.py_has_next_iter(n21, n2)
          jmp b4, b5
