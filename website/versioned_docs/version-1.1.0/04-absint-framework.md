...
checker on real code. See [here](/docs/1.1.0/analyzing-apps-or-projects) for more
...
[`Reporting.log_issue`](pathname:///odoc/1.1.0/infer/Absint/Reporting/index.html#val-log_issue).
...
[Absint](pathname:///odoc/1.1.0/infer/Absint.html) and
[IR](pathname:///odoc/1.1.0/infer/IR.html) modules.
