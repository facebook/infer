...
*Category: [Runtime exception](/docs/next/all-categories#runtime-exception). Reported as "Assertion Error" by [pulse](/docs/next/checker-pulse).*
...
A latent [SWIFT_NPE](#swift_npe). See the [documentation on Pulse latent issues](/docs/next/checker-pulse#latent-issues).
## TAINT_ERROR
