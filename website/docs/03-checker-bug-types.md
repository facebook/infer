...
- [Checkers Immutable Cast](#CHECKERS_IMMUTABLE_CAST)
- [Deadlock](#DEADLOCK)
- [Dead store](#DEAD_STORE)
- [Empty Vector Access](#EMPTY_VECTOR_ACCESS)
- [Field should be nullable](#FIELD_SHOULD_BE_NULLABLE)
- [Fragment retains view](#FRAGMENT_RETAINS_VIEW)
- [Interface not thread-safe](#INTERFACE_NOT_THREAD_SAFE)
- [Ivar not null checked](#IVAR_NOT_NULL_CHECKED)
- [Lock Consistency Violation](#LOCK_CONSISTENCY_VIOLATION)
- [Memory leak](#MEMORY_LEAK)
- [Mixed self weakSelf](#MIXED_SELF_WEAKSELF)
- [Null dereference](#NULL_DEREFERENCE)
- [Parameter not null checked](#PARAMETER_NOT_NULL_CHECKED)
- [Premature nil termination argument](#PREMATURE_NIL_TERMINATION_ARGUMENT)
- [Resource leak](#RESOURCE_LEAK)
- [Retain cycle](#RETAIN_CYCLE)
- [Static initialization order fiasco](#STATIC_INITIALIZATION_ORDER_FIASCO)
- [Strict mode violation](#STRICT_MODE_VIOLATION)
- [StrongSelf Not Checked](#STRONG_SELF_NOT_CHECKED)
- [Thread-safety violation](#THREAD_SAFETY_VIOLATION)
- [UI Thread Starvation](#STARVATION)
- [Unsafe_GuardedBy_Access](#UNSAFE_GUARDEDBY_ACCESS)
...
features. See the [RacerD page](/racerd) for more in-depth information
and examples.
