...
- [AL: A declarative language for writing linters in Infer](#al_intro)
- [Getting the clang AST](#clang_ast)
- [Using AL to write linters](#write_linters)
  - [General structure of a checker](#checker_structure)
  - [Defining Paths](#paths)
  - [Defining Macros](#macros)
  - [AL Predicates](#predicates)
  - [AL Formulas](#formulas)
  - [Example AL checkers:](#examples)
    - [Objective-C class that inherits from a class that shouldn't be subclassed](#subclass_check)
    - [Objective-C instance method call](#instance_method_check)
    - [Objective-C instance method call of any method of a class](#any_instance_method_check)
    - [Objective-C class method call](#class_method_check)
    - [Objective-C method call of a method with int return type](#return_type)
    - [Variable declaration with type long](#variable_type)
    - [Method that has a parameter of type A\*](#some_parameter)
    - [Method that has all the parameters of type A\* (and at least one)](#all_parameters)
    - [Method that has the 2nd parameter of type A\* ](#sec_parameter)
    - [Protocol that inherits from a given protocol](#protocol)
    - [Constructor is defined with a parameter of a type that implements a given protocol](#constructor_protocol_type)
    - [Variable declaration of type NSArray applied to A](#nsarray_generics)
    - [Using a property or variable that is not available in the supported API](#unavailable_api)
    - [Using a given namespace](#use_namespace)
    - [A check for flagging the use of given enum constants](#enum_constants)
  - [AST info in messages](#info_message)
  - [Testing your rule](#testing)
  - [Debugging](#debugging)
  - [Demo](#demo)
  - [Command line options for linters](#command_line)
