...
- [MEMORY_LEAK_LATENT](/docs/next/all-issue-types#memory_leak_latent)
...
- [PULSE_UNNECESSARY_COPY_LATENT](/docs/next/all-issue-types#pulse_unnecessary_copy_latent)
- [STACK_VARIABLE_ADDRESS_ESCAPE](/docs/next/all-issue-types#stack_variable_address_escape)
- [STACK_VARIABLE_ADDRESS_ESCAPE_LATENT](/docs/next/all-issue-types#stack_variable_address_escape_latent)
