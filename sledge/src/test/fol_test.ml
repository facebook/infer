  ...
  ( module struct
    ...
    let%expect_test _ =
      ...
      { sat= false;
        ...
        cls= [[(%y_6 - 2) ↦ {f(%y_6)}];
              [(%y_6 + 1) ↦ {%x_5}];
              [(%y_6 + 3) ↦ {f((%x_5 - 1))}]];
        use= [[%y_6 ↦ (%y_6 - 2), (%y_6 + 1), (%y_6 + 3), f(%y_6)]] } |}]
    ...
    let%expect_test _ =
      ...
      [%expect
        {|
      { sat= false;
        rep= [[%y_6 ↦ %x_5]; [f(%x_5) ↦ %x_5]; [f(%y_6) ↦ (%x_5 - 1)]];
        cls= [[%x_5 ↦ {%y_6, f(%x_5)}]; [(%x_5 - 1) ↦ {f(%y_6)}]];
        use= [[%x_5 ↦ (%x_5 - 1), f(%x_5)]] } |}]
    ...
    let%expect_test _ =
      ...
      [%expect
        {|
        { sat= true;
          rep= [[f(%x_5) ↦ %x_5]; [f(%y_6) ↦ (%y_6 - 1)]];
          cls= [[%x_5 ↦ {f(%x_5)}]; [(%y_6 - 1) ↦ {f(%y_6)}]];
          use= [[%x_5 ↦ f(%x_5)]; [%y_6 ↦ (%y_6 - 1), f(%y_6)]] }
