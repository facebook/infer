...
install_opam_deps () {
    ...
    opam pin add --no-action charon https://github.com/AeneasVerif/charon.git
    opam pin add --no-action name_matcher_parser https://github.com/AeneasVerif/charon.git
